              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Motorista</p>
                  </div>
                </div>
                ...
                <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                  &quot;Ótimo atendimento! O guincho chegou rápido e foi muito profissional. Recomendo!&quot;
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Executiva</p>
                  </div>
                </div>
                <div className="flex gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                  &quot;Precisei de guincho na rodovia e o serviço foi excelente. Motorista experiente e cuidadoso com
                  meu carro. Nota 10!&quot;
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">Autônomo</p>
                  </div>
                </div>
                <div className="flex gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-sm sm:text-base text-zinc-300 leading-relaxed">
                  &quot;Recomendo de olhos fechados! Tive problema no centro da cidade e em 15 minutos estavam lá.
